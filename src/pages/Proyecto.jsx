		...
		<div className="select-none">
			{alerta.error && error ? (
				...
				<>
					...
					{editando && (
						<div className="fixed top-0 mt-8 ml-4">
							<Tooltip
								className="bg-teal-500 font-black uppercase"
								id="editando"
							/>
							<p
								data-tooltip-id="editando"
								data-tooltip-content="Editando..."
								className="flex justify-center items-center gap-4 text-sky-500 font-black uppercase text-lg bg-gray-900 border-[3px] border-gray-950 hover:border-teal-500 hover:text-teal-500 transition-colors duration-300 p-4 rounded-lg"
							>
								<FiEdit2 fontSize={25} />
							</p>
						</div>
